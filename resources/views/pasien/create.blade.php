            ...
            <div class="row g-3 g-lg-4">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="card border-0 shadow-card rounded-xl mb-3 mb-lg-4">
                        <div class="card-header bg-white border-bottom pt-4 pb-3 px-3 px-md-4">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label form-label-required small fw-bold">Nama Lengkap Pasien</label>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label form-label-required small fw-bold">NIK (16 Digit)</label>
                                    <input type="text" name="nik" class="form-control-peka @error('nik') is-invalid @enderror" value="{{ old('nik') }}" maxlength="16" placeholder="3509..." required>
                                ...
                                <div class="col-6 col-md-4">
                                    ...
                                    <div class="input-group-peka">
                                        <input type="number" step="0.1" name="tinggi_badan" class="form-control-peka" value="{{ old('tinggi_badan', 0) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="alamat" class="form-control-peka @error('alamat') is-invalid @enderror" rows="2" placeholder="Jl. Raya No. 123, RT/RW..." required>{{ old('alamat') }}</textarea>
                ...
                <div class="col-12 col-lg-5">
                    ...
                    <div class="card border-0 shadow-card rounded-xl mb-4">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label form-label-required small fw-bold">HPHT (Hari Pertama Haid Terakhir)</label>
                                    <input type="date" name="hpht" class="form-control-peka @error('hpht') is-invalid @enderror" value="{{ old('hpht') }}" required>
                                    @error('hpht') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                </div>
                                
                                <div class="col-12">
                                    <label class="form-label form-label-required small fw-bold">Status Obstetri (GPA)</label>
                                    <div class="row g-2">
                                        <div class="col-4">
                                            <div class="input-group-peka">
                                                <span class="input-icon fw-bold text-primary" style="left: 12px; top: 12px;">G</span>
                                                <input type="number" name="gravida" class="form-control-peka ps-4" min="1" value="{{ old('gravida', 1) }}" required>
                                            </div>
                                            <div class="text-center x-small text-muted mt-1">Hamil</div>
                                        </div>
                                        <div class="col-4">
                                            <div class="input-group-peka">
                                                <span class="input-icon fw-bold text-success" style="left: 12px; top: 12px;">P</span>
                                                <input type="number" name="para" class="form-control-peka ps-4" min="0" value="{{ old('para', 0) }}" required>
                                            </div>
                                            <div class="text-center x-small text-muted mt-1">Lahir</div>
                                        </div>
                                        <div class="col-4">
                                            <div class="input-group-peka">
                                                <span class="input-icon fw-bold text-danger" style="left: 12px; top: 12px;">A</span>
                                                <input type="number" name="abortus" class="form-control-peka ps-4" min="0" value="{{ old('abortus', 0) }}" required>
                                            </div>
                                            <div class="text-center x-small text-muted mt-1">Gugur</div>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-12 mt-3 pt-2">
                                    <label class="form-label mb-3 small fw-bold border-bottom pb-2 w-100">Faktor Risiko Awal</label>
                                    <div class="row g-2">
                                        <div class="col-12">
                                            <div class="form-check form-switch custom-switch">
                                                <input class="form-check-input" type="checkbox" name="riwayat_preeklampsia" id="r_pe" value="1">
                                                <label class="form-check-label small" for="r_pe">Riwayat Preeklampsia</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check form-switch custom-switch">
                                                <input class="form-check-input" type="checkbox" name="riwayat_hipertensi" id="r_ht" value="1">
                                                <label class="form-check-label small" for="r_ht">Hipertensi Kronis</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check form-switch custom-switch">
                                                <input class="form-check-input" type="checkbox" name="riwayat_diabetes" id="r_dm" value="1">
                                                <label class="form-check-label small" for="r_dm">Diabetes Mellitus</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-light btn-sm w-100 border-dashed py-2 small" type="button" data-bs-toggle="collapse" data-bs-target="#moreRisks">
                                                <i class="fas fa-plus me-1"></i> Faktor Lainnya
                                            </button>
                                        </div>
                                        <div class="collapse col-12" id="moreRisks">
                                            <div class="p-3 bg-light rounded-3 mt-2">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label small" for="r_gn">Penyakit Ginjal</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="keluarga_preeklampsia" id="r_kpe" value="1">
                                                    <label class="form-check-label small" for="r_kpe">Keluarga dengan PE</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="kehamilan_kembar" id="r_kem" value="1">
                                                    <label class="form-check-label small" for="r_kem">Kehamilan Kembar</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card border-0 shadow-card rounded-xl bg-peka-primary text-white p-3 p-md-4 mb-5">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="mb-0 fw-bold">Konfirmasi Data</h6>
                        </div>
                        <p class="x-small mb-3 opacity-75">Data NIK dan HPHT akan digunakan sebagai basis perhitungan risiko dan login portal pasien.</p>
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-light fw-bold text-peka-primary py-3">
                                <i class="fas fa-save me-2"></i> SIMPAN & DAFTARKAN
                            </button>
                            <a href="{{ route('pasien.index') }}" class="btn btn-link btn-sm text-white text-decoration-none opacity-75">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
