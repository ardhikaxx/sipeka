  ...
  <div class="d-flex align-items-center gap-3 gap-md-4">
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-dark user-dropdown-toggle p-1 rounded-pill" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="avatar-circle bg-gradient-premium text-white shadow-sm d-flex align-items-center justify-content-center fw-bold border border-white" style="width: 38px; height: 38px; font-size: 1rem;">
      ...
      <ul class="dropdown-menu dropdown-menu-end shadow-card border-0 mt-3 rounded-4 p-2 overflow-hidden" style="min-width: 220px;">
        ...
        <li>
            <a class="dropdown-item py-2 px-3 rounded-3 d-flex align-items-center gap-2 mb-1" href="{{ route('profile') }}">
        ...
        <li>
            <a class="dropdown-item py-2 px-3 rounded-3 d-flex align-items-center gap-2 mb-2" href="{{ route('settings') }}">
